        ...
        <CardContent className="space-y-6">
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="bg-primary/5 border border-primary/20 rounded-lg p-3 space-y-2 mt-4">
              <Label htmlFor="demo-role" className="text-xs flex items-center gap-1.5 font-bold text-primary">
              ...
              <select
                ...
                className="w-full bg-background border border-input rounded px-2 py-1 text-xs h-8 outline-none focus:ring-1 focus:ring-primary cursor-pointer font-medium"
              >
                <option value="ADMIN">🛡️ Admin (Manage team, settings & billing)</option>
                <option value="DEVELOPER">⚙️ Developer (Optimize schedules & edit data)</option>
                <option value="GUEST">👁️ Guest (View only dashboard & schedules)</option>
              </select>
            ...
            <Button 
              ...
              onClick={() => {
                ...
                toast.success(language === "de" ? `Schnellzugriff aktiv: Anmeldung als ${simulatedRole}...` : `Quick Access active. Signed in as ${simulatedRole}...`);
                navigate({ to: "/dashboard" });
              }}
