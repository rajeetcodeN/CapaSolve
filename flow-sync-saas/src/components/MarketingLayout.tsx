        ...
        <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/80 backdrop-blur-md">
          <div className="mx-auto flex h-16 max-w-[1400px] items-center justify-between px-6">
            ...
            <Link to="/" className="flex items-center gap-2 font-bold text-xl tracking-tight hover:opacity-90">
              ...
              <span className="bg-gradient-to-r from-primary via-blue-600 to-indigo-500 bg-clip-text text-transparent">CapaSolve</span>
            </Link>
            ...
            <nav className="hidden md:flex items-center gap-8 text-sm font-medium">
              ...
              <Link 
                ...
                className={cn(
                  "transition-colors", 
                  pathname === "/pricing" ? "text-primary font-semibold" : "text-muted-foreground hover:text-foreground"
                )}
              >
            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              <Button asChild size="sm" className="cursor-pointer bg-primary text-primary-foreground hover:bg-primary/95 shadow-sm">
      ...
      <footer className="border-t border-border/40 bg-muted/40 py-12 px-6">
        <div className="mx-auto max-w-[1400px]">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
            ...
            <div className="col-span-2 space-y-4 text-left">
              ...
              <p className="text-xs text-muted-foreground max-w-xs leading-relaxed">
                {t("marketing.footerDesc" as any) || "AI-powered constraint-based manufacturing scheduling and capacity optimization platform."}
              </p>
              <div className="pt-4 flex gap-3 items-center">
                <img src="/digitalbiz_Logo.jpg" alt="Digital Biz Tech Logo" className="h-9 object-contain rounded bg-white p-1 border border-border/40 shrink-0 shadow-xs" />
                <div className="text-[10px] text-muted-foreground leading-tight">
                  <p className="font-bold text-foreground hover:text-primary transition-colors">
                    <a href="https://www.digitalbiz.tech/" target="_blank" rel="noopener noreferrer">Digital Biz Tech &rarr;</a>
                  </p>
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  {pathname === "/" ? (
                    ...
                    <Link to="/" hash="features" className="text-muted-foreground hover:text-foreground transition-colors">Features</Link>
                  )}
                </li>
                <li><Link to="/pricing" className="text-muted-foreground hover:text-foreground transition-colors">Pricing</Link></li>
                <li><Link to="/dashboard" className="text-muted-foreground hover:text-foreground transition-colors">Interactive Demo</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><Link to="/api-reference" className="text-muted-foreground hover:text-foreground transition-colors">API Reference</Link></li>
                <li><Link to="/support" className="text-muted-foreground hover:text-foreground transition-colors">Support Portal</Link></li>
              </ul>
            </div>
          ...
          <div className="border-t border-border/40 mt-8 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-muted-foreground">
            <div>
              &copy; 2026 Digital Biz Tech. All rights reserved.
            </div>
